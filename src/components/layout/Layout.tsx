...
export function Layout() {
  ...
  return (
    <div style={{
      ...
      {/* Mesh gradient blobs — fixed so they persist across routes */}
      ...
      <main style={{ position: 'relative', zIndex: 1, maxWidth: 430, margin: '0 auto', paddingBottom: 100, padding: '0 0 100px' }}>
        <Outlet />
      </main>
